...
import { PageBlock, IBarChartConfig, callAPI, formatNumber, groupByCategory, extractUniqueTimes, concatUnique, groupArrayByKey, formatNumberByFormat } from './global/index';
...
export default class ScomBarChart extends Module implements PageBlock {
  ...
  private _oldData: IBarChartConfig = { apiEndpoint: '', options: undefined };
  ...
  async setData(data: IBarChartConfig) {
  ...
  private renderChart() {
    ...
    const chart = new BarChart(this.pnlChart, {
      data: _chartData,
      width: '100%',
      height: '100%'
    });
